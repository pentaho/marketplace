...
public class DiPluginTelemetry implements ITelemetryService {
     ...
     */
    public ITelemetryService getBaseTelemetryService() {
        return this.baseTelemetryService;
    }
    protected void setBaseTelemetryService(ITelemetryService baseTelemetryService) {
        this.baseTelemetryService = baseTelemetryService;
    }
    private ITelemetryService baseTelemetryService;
    ...
    public DiPluginTelemetry( ITelemetryService baseTelemetryService,
                              String telemetryUrl,
                              boolean telemetryEnabled ) {
        this.setBaseTelemetryService(baseTelemetryService);
    ...
    public boolean publishEvent( TelemetryEvent event ) {
        ...
        if ( this.getBaseTelemetryService() == null ) {
        ...
        return this.getBaseTelemetryService().publishEvent(event);
    }
