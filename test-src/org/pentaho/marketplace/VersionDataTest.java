...
public class VersionDataTest {
  ...
  public void testVersionData() {
    ...
    Assert.assertEquals("4.5.0-GA", vd.info);
    Assert.assertEquals(4, vd.major);
    Assert.assertEquals(5, vd.minor);
    Assert.assertEquals(0, vd.patch);
    ...
    Assert.assertEquals("4.5.0-stable", vd.info);
    Assert.assertEquals(4, vd.major);
    Assert.assertEquals(5, vd.minor);
    Assert.assertEquals(0, vd.patch);
    ...
    Assert.assertEquals(4, vd.major);
    Assert.assertEquals(5, vd.minor);
    Assert.assertEquals(Integer.MAX_VALUE, vd.patch);
    
    vd = new VersionData("TRUNK-SNAPSHOT");    
    Assert.assertEquals(Integer.MAX_VALUE, vd.major);
    Assert.assertEquals(Integer.MAX_VALUE, vd.minor);
    Assert.assertEquals(Integer.MAX_VALUE, vd.patch);
    ...
    Assert.assertEquals(4, vd.major);
    Assert.assertEquals(0, vd.minor);
    Assert.assertEquals(0, vd.patch);
